                ...
                <form class="w-100 order-form" id="order_form" name="checkout_form" method="POST">
                    <div class="left-col">
                        <div class="your-order">
                            <h3 class="form-heading mb-5">Your Products</h3>
                            <p id="p_name_all"></p>
                    ...
                    <div class="wrapper">
                        <div class="common-col center-col col-lg-3">
                            <h3 class="form-heading mb-5">Billing Details</h3>
