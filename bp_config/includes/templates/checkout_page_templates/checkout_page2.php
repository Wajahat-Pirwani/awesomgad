                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 left order-md-1 order-2">
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="field-wrapper notes">
                                                ...
                                                <textarea id="order-notes" name="notes" placeholder="Order Notes(Optional)"></textarea>
                                            </div>
                                        </div>
                                                ...
                                                <div class="payment-form px-3 py-3 row m-0">
                                                    <div class="col-12">
                                                        <div class="field-wrapper card-num">
                                                            ...
                                                            <input type="tel" class="form-control" name="cc_no" id="cc_no" maxlength="16" onkeyup="javascript:this.value=this.value.replace(/[^0-9]/g,'');" value="" placeholder="Card Number">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                        ...
                                        <div class="btn-wrapper mt-5">
                                            ...
                                            <button type="button" class="btn btn-order" id="btnPlaceOrder" onclick="formStep2Validation()">Place Order</button>
                                        </div>
                        ...
                        cartPdtArrNew.forEach(function(b) {
                            if (b.Saletype == 1 && $('.ss_agree-' + b.Id).is(":checked") == false) {
                                if ($('.terms-btn .error2' + b.Id + '').length == 0)
                                    $('.terms-btn').prepend('<div class="error error2' + b.Id + ' mt-1">Please agree to the ' + b.Name + ' terms<br></div>');
