                ...
                <form class="w-100 order-form" id="order_form" name="checkout_form" method="POST">
                    <div class="row">
                        <div class="col-12 col-md-6 left-col">
                            <div class="left-row1">
                                <h3 class="form-heading mb-3">Delivery Options</h3>
                                <div class="row">
                            ...
                            <div class="left-row2">
                                <h3 class="form-heading mb-3">Payment</h3>
                                <div class="payment-wrapper">
                                    <div class="payment mb-4">
                                        <div class="payment-header d-flex justify-content-between px-0 pb-3 align-items-center">
                                            <label class="mb-0">
                        ...
                        <div class="col-12 col-md-5 right-col">
                            <div class="your-order">
                                <h3 class="form-heading mb-3">In Your Bag</h3>
                                <p id="p_name_all"></p>
                                <table class="table  table-cart mb-5">
                                    <tfoot>
                                        <tr>
                                            <td class="form-heading2" colspan="3">Subtotal</td>
                                            <td class="form-heading2">$<span id="product_subtotal" value='0.00'>0.00</span></td>
                                        </tr>
                                        <?php if ($pageConfig['displayShippingPrice'] == "yes") { ?>
                                            <tr>
                                                <td class="form-heading2" colspan="3">Shipping</td>
                                                <td class="form-heading2"><span class="currency_symbol">€</span><span id="shipping_subtotal" value='0.00'>0.00</span></td>
                                            </tr>
                                        <?php } ?>
                                        <tr id="shipping-insurance-tr" style="display: none;">
                                            <td class="form-heading2" colspan="3"><?= $pageConfig['shippingOption']['shippingOptionName']; ?></td>
                                            <td class="form-heading2"><span class="currency_symbol">€</span><span id="shipping-insurance-price" value='0.00'><?= $pageConfig['shippingOption']['shippingOptionPrice']; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td class="form-heading2 total" colspan="3">Total</td>
                                            <td class="form-heading2">$<span id="final_price" value='0.00'>0.00</span></td>
