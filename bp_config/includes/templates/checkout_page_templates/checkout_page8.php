    ...
    <div class="container">
        ...
        <div class="form-wrapper mt-5">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="shippingAddress1" id="shippingAddress1" placeholder="Street Address" value="">
                        </div>
                        <div class="form-group">
                            <label>Town/City:<sup>*</sup></label>
                            <input type="text" class="form-control" name="shippingCity" id="shippingCity" placeholder="Town/City" value="">
                        </div>
                        <div class="form-group">
                            <label>Country:<sup>*</sup></label>
                            <!-- <input type="text" class="form-control" name="shippingCountry" id="shippingCountry" placeholder="Country" value="US" readonly> -->
                            <select name="shippingCountry" id="shippingCountry" class="form-control " autocomplete="address-level1" data-placeholder="Country" data-input-classes="" placeholder="Country" tabindex="-1" aria-hidden="true">
                                <option value="France" <?php if ($_POST['shippingCountry'] == 'France') {
                                                            echo 'selected';
                                                        } ?>>France
                                </option>
                                <option value="Italy" <?php if ($_POST['shippingCountry'] == 'Italy') {
                                                            echo 'selected';
                                                        } ?>>Italy
                                </option>
                                <option value="Spain" <?php if ($_POST['shippingCountry'] == 'Spain') {
                                                            echo 'selected';
                                                        } ?>>Spain
                                </option>
                                <option value="Denmark" <?php if ($_POST['shippingCountry'] == 'Denmark') {
                                                            echo 'selected';
                                                        } ?>>Denmark
                                </option>
                                <option value="UK" <?php if ($_POST['shippingCountry'] == 'UK') {
                                                        echo 'selected';
                                                    } ?>>UK
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <!-- <select name="shippingState" id="shipping_state" class="form-control " autocomplete="address-level1" data-placeholder="State / Province" data-input-classes="" placeholder="State / Province" tabindex="-1" aria-hidden="true">
                                ...
                                <option value="DC" <?php if ($_POST['shippingState'] == 'DC') {
                                                        echo 'selected';
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="shippingZip" id="shippingZip" placeholder="Zip Code" maxlength="5" onKeyUp="javascript:this.value=this.value.replace(/[^0-9]/g,'');" value="">
                        </div>
                        <div class="form-group">
                            <label>Phone:<sup>*</sup></label>
                            <input type="tel" class="form-control" name="phone" id="phone" placeholder="Phone Number" data-min-length="10" data-max-length="15" onkeyup="javascript:this.value=this.value.replace(/[^0-9]/g,'');" maxlength="10" value="">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <table class="table mb-5">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><span class="currency_symbol">€</span><span id="product_subtotal" value='0.00'>0.00</span></td>
                                </tr>
                                <?php if ($pageConfig['displayShippingPrice'] == "yes") { ?>
                                    <tr>
                                        <td colspan="2">Shipping</td>
                                        <td><span class="currency_symbol">€</span><span id="shipping_subtotal" value='0.00'>0.00</span></td>
                                    </tr>
                                <?php } ?>
                                <tr id="shipping-insurance-tr" style="display: none;">
                                    <td colspan="2"><?= $pageConfig['shippingOption']['shippingOptionName']; ?></td>
                                    <td><span class="currency_symbol">€</span><span id="shipping-insurance-price" value='0.00'><?= $pageConfig['shippingOption']['shippingOptionPrice']; ?></span></td>
                                </tr>
                                <tr>
                                    <td colspan="2">Total</td>
                                    <td><span class="currency_symbol">€</span><span id="final_price" value='0.00'>0.00</span></td>
                        ...
                        <div class="payment mb-4">
                            ...
                            <div class="payment-form px-3 py-3 row m-0">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="tel" class="form-control" name="cc_no" id="cc_no" maxlength="16" onkeyup="javascript:this.value=this.value.replace(/[^0-9]/g,'');" value="" placeholder="Card No">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <select class="form-control" name="cc_month" id="cc_month" maxlength="2" placeholder="Month(MM)">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <select class="form-control" name="cc_year" id="cc_year" maxlength="4" placeholder="Year(YYYY)">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-0">
                                        <input type="tel" class="form-control" name="CVV" id="cvv" maxlength="3" onkeyup="javascript:this.value=this.value.replace(/[^0-9]/g,'');" placeholder="CVV" value="">
                                    </div>
                                </div>
                                <div class="col-6">
            ...
            <label for="vehicle1" id="pv" class="agree" style="display:none;">
                ...
                By placing an order you will be billed <span class="currency_symbol">€</span><span class="total_price"></span> (<span class="currency_symbol">€</span><span class="total_price"></span> + <span class="currency_symbol">€</span><span id="ship_price"></span> for shipping) for <span id="prod_name"></span>. This is a one-time purchase. Shipment via <?php echo $generalConfig['shipping_carrier']; ?> typically takes <?php echo $generalConfig['shipping_period']; ?> business days. Your credit card will be billed as “<?php echo $generalConfig['descriptor']; ?>” on your statement. -->
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($pageConfig['shippingOption']['enableShippingOption'] == "yes") { ?>
                            <label class="agree" style="font-size: 15px;">
                                ...
                                <?= $pageConfig['shippingOption']['shippingOptionName']; ?> - <span class="currency_symbol">€</span><?= $pageConfig['shippingOption']['shippingOptionPrice']; ?>
                            </label>
                            <script>
                                $(document).ready(function() {
                                    $('#shipping-insurance-checkbox').change(function() {
                                        if (this.checked) {
                                            ...
                                            $('#final_price').text(($('#final_price').text() * 1) + ($('#shipping-insurance-price').text() * 1));
                                        } else {
                        ...
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-order primary_color primary_text_color" id="btnPlaceOrder">Place Order</button>
                        </div>
                        <div class="text-center d-flex align-items-center justify-content-center mt-3">
                            <a class="shop-btn" href="shop.php">Continue Shopping</a>
...
<script>
    $(document).ready(function() {
        // Get the session storage data array
        var cartProducts = JSON.parse(sessionStorage.getItem("cartPdtArrNew"));
        var cartTotal = 0;

        // Check if session storage data exists
        if (cartProducts) {
            // Loop through the session storage data array and insert it into HTML rows
            for (var i = 0; i < cartProducts.length; i++) {
                var index = i + 1;
                var data = cartProducts[i];
                var cartItem = `<div class="details shadow">
                    <div class="details__item">
                        <div class="item__image">
                            <img class="iphone" src="` + data.Image + `" alt="" />
                        </div>
                        <div class="item__details">
                            <div class="item__title">` + data.Name + `</div>
                            <div class="item__price"><span class="currency_symbol">€</span> ` + data.Price + `</div>
                        </div>
                    </div>
                </div>`;
            ...
            $("#total-price").html('<span class="currency_symbol">€</span>' + cartTotal.toFixed(2));
        }
    });
</script>
