        ...
        <div class="row">
            ...
            <div class="col-12">
                <form class="w-100 order-form" id="order_form" name="checkout_form" method="POST">
                    <div class="wrapper">
                        <div class="common-col left-col">
                            <div class="your-order">
                                <h3 class="form-heading mb-3">Your Order</h3>
                                <p id="p_name_all"></p>
                                <table class="table  table-cart mb-5">
                                    <thead>
                                        <tr>
                                            <th colspan="3" class="form-heading">Product</th>
                                            <th class="form-heading">Subtotal</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td class="form-heading" colspan="3">Subtotal</td>
                                            <td class="form-heading">$<span id="product_subtotal" value='0.00'>0.00</span></td>
                                        </tr>
                                        <?php if ($pageConfig['displayShippingPrice'] == "yes") { ?>
                                            <tr>
                                                <td class="form-heading" colspan="3">Shipping</td>
                                                <td class="form-heading"><span class="currency_symbol">€</span><span id="shipping_subtotal" value='0.00'>0.00</span></td>
                                            </tr>
                                        <?php } ?>
                                        <tr id="shipping-insurance-tr" style="display: none;">
                                            <td class="form-heading" colspan="3"><?= $pageConfig['shippingOption']['shippingOptionName']; ?></td>
                                            <td class="form-heading"><span class="currency_symbol">€</span><span id="shipping-insurance-price" value='0.00'><?= $pageConfig['shippingOption']['shippingOptionPrice']; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td class="form-heading" colspan="3">Total</td>
                                            <td class="form-heading">$<span id="final_price" value='0.00'>0.00</span></td>
                        ...
                        <div class="common-col center-col">
                        ...
                        <div class="common-col right-col">
                            <div class="payment-wrapper">
                                <div class="payment mb-4">
                                    <div class="payment-header d-flex justify-content-between py-3 align-items-center">
                                        <h3 class="form-heading mb-3">Payment Details</h3>
                                        <!-- <label class="mb-0">
                                    ...
                                    <div class="payment-form py-3 row m-0">
                                ...
                                <div class="form-btn p-4">
                                    ...
                                    <?php if ($pageConfig['shippingOption']['enableShippingOption'] == "yes") { ?>
                                        <label class="agree" style="font-size: 15px;">
                                            ...
                                            <?= $pageConfig['shippingOption']['shippingOptionName']; ?> - $<?= $pageConfig['shippingOption']['shippingOptionPrice']; ?>
                                        </label>
                                        <script>
