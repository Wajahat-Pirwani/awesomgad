    ...
    <div class="row">
      <div class="col-lg-3">
        <div class="company-info">
          <h5>About Us</h5>
          <ul>  
            <li>Hamalty Limited</li>
            <li>Registration #14910255</li>
            <li>23 Prospect Avenue, South Normanton, Alfreton</li>
            <li>Derbyshire, DE55 2BA</li>
      ...
      <div class="col-lg-3 col-md-4">
        <div>
          ...
          <li><a href="club.php">Club Membership</a></li>
      ...
      <div class="col-lg-3 col-md-4 pt-md-0 pt-5">
        <h5>Useful Links</h5>
           <ul>
            ...
            $found_ingridient = array_search('yes',$show_ingridient_find);
          ?>
           <li><a href="paymentrefundpolicy.php">Payment & Refund Policy</a></li>
