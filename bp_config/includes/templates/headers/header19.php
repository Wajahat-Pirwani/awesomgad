<section class="header_section header_section19" id="header_section">
   ...
   <div class="topbar topbar-background-color topbar-text-color top-bar">
      <div class="container">
         <div class="row align-content-between">
            <div class="col icons">
               <span class="d-lg-inline me-4 pe-4 topbar19-content">
   ...
   <header class="nav-color main-header">
      ...
      <div class="container top-head d-none d-lg-flex">
         <div class="row align-items-center">
            <div class="p-0 header19-navbar-brand">
               <div class="navbar"> <a class="header_brand nav-text-color" href="index.php"><?= $generalConfig['brand_name'] ?></a></div>
            </div>
            <div class="d-flex align-items-center header19-content p-0">
               <div class="navRight">
                  <ul class="d-flex align-items-center m-0">
                     <li class="ms-4">
                        <div class="header-icon pe-4 h-100">
                           <i class="fas fa-map-marker-alt nav-icon-color header19-marker"></i>
               ...
               <div class="navRight">
                  <ul class="d-flex align-items-center m-0">
                     <li class="ms-4">
                        <div class="header-icon pe-4 h-100">
                           <i class="far fa-clock nav-icon-color header19-clock"></i>
                           <span class="text-left ms-3 nav-text-color">
                              <div class="top-text nav-text-color">CALL US NOW</div>
                              <div class="bottom-text nav-text-color">
                                 <?= $generalConfig['phone_number'] ?>
               ...
               <div class="navRight">
                  <ul class="d-flex align-items-center m-0">
                     <li class="ms-4">
                        <a href="contact.php" class="header19-contact-btn primary_color primary_text_color">Contact Us</a>
                     </li>
                  </ul>
               </div>
            </div>
      ...
      <!----Bottom Header---->
      <div class="header19-bottom-header">
         <div class="container bottom-head nav-txt-color-bottom position-relative mt-3">
            <div class="navbarMobile me-auto d-flex d-lg-none header19-mobile-content-1"> <a class="header_brand nav-text-color" href="index.php"><?= $generalConfig['brand_name'] ?></a></div>
            <div class="col-2 col-lg-12 d-flex align-items-center p-0 w-100 header19-mobile-content-2">
