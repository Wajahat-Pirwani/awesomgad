<section class="header_section header_section21" id="header_section">

  <!-----Header-top-bar Starts here----->
  <div class="topbar topbar-background-color topbar-text-color top-bar">
    <div class="container">
      <div class="row align-content-between topbar-main-content">
        <div class="col icons topbar-icons-content">
          <span class="d-lg-inline me-4 pe-4 topbar21-content">
        ...
        <div class="navRight topbar-contact-btn">
          <ul class="d-flex align-items-center m-0 p-0">
            <li class="m-0">
              <a href="contact.php" class="primary_color primary_text_color header21-contact-btn">Contact Us</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <header class="nav-color main-header">
    ...
    <!-----Top Header----->
    <div class="container top-head d-lg-flex">
      <div class="row align-items-center">
        <div class="p-0 header21-navbar-brand">
          <div class="navbar"> <a class="header_brand nav-text-color" href="index.php"><?= $generalConfig['brand_name'] ?></a></div>
        </div>
        <div class="d-flex align-items-center header21-content">
          <div class="bottom-head nav-txt-color-bottom position-relative">
            <div class="navbarMobile me-auto d-flex d-lg-none header21-mobile-content-1"> <a class="header_brand nav-text-color" href="index.php"><?= $generalConfig['brand_name'] ?></a></div>
            <div class="col-2 col-lg-12 d-flex align-items-center p-0 w-100 header21-mobile-content-2">
