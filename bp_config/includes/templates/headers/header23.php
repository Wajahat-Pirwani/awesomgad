<section class="header_section header_section23">

   <!-----Header-top-bar Starts here----->
   <div class="topbar topbar-background-color topbar-text-color top-bar">
      <div class="row align-content-between px-4 py-2">
         <div class="navRight topbar-contact-btn">
            <ul class="d-flex align-items-center m-0">
               <li class="ms-4">
                  <a href="contact.php" class="primary_color primary_text_color header23-contact-btn">Contact Us</a>
               </li>
            </ul>
         </div>
      </div>
