<section class="header_section header_section25">

   <!-----Header-top-bar Starts here----->
   <div class="topbar topbar-background-color topbar-text-color top-bar">
      <div class="align-content-between px-4 py-2">
         <div class="container navRight topbar-contact-btn">
            <ul class="d-flex align-items-center m-0 p-0">
               <li class="m-0">
                  <h4 href="" class="header25-contact-btn topbar_text_color m-0"><?= $updateContent['slogan'] ?></h4>
               </li>
            </ul>
         </div>
      </div>
   ...
   <header>
      ...
      <nav class="navbar navbar-expand-lg nav-color">
         <div class="container container-fluid px-0">
            <div class="collapse navbar-collapse nav-menu desktop-menu" id="navbarSupportedContent">
               <ul class="navbar-nav m-0">
                  <li class="nav-item">
                     <a class="nav-link active nav-active-color me-3 px-2" aria-current="page" href="index.php">Home</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link nav-text-color me-3 px-2" href="shop.php">Shop</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link nav-text-color me-3 px-2" href="checkout.php">Checkout</a>
                  </li>
               </ul>
            </div>

            <div class="brand-name-box brand-name">
            ...
            <!-- Cart Button  -->
            <div class="brand-name-box cart d-flex justify-content-end">
               <div class="navbar-contact-btn">
                  <a href="contact.php" class="p-3 primary_color primary_text_color">Contact</a>
               </div>
      ...
      <!-- Bottom-Menu -->
      <div class="bottom-navbar p-0 nav-color">
         <ul class="container p-0 py-2 d-flex mb-0">
            <li class="nav-item">
               <a class="nav-link nav-text-color m-0 px-2" href="terms.php">Term</a>
            </li>
            <li class="nav-item">
               <a class="nav-link nav-text-color m-0 px-2" href="privacy.php">Privacy</a>
            </li>
            <li class="nav-item">
               <a class="nav-link nav-text-color m-0 px-2" href="contact.php">Contact</a>
            </li>
         </ul>
      </div>
