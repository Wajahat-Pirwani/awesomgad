<section class="header_section header_section26">
   ...
   <div class="topbar topbar-background-color topbar-text-color top-bar">
      <div class="align-content-between px-4 py-2">
         <div class="container navRight topbar-contact-btn px-1">
            <ul class="d-flex align-items-center m-0 p-0">
               <li class="m-0">
                  <h4 href="" class="header26-contact-btn topbar_text_color m-0">Fast shipping Everday - 30 days Return</h4>
               </li>
            </ul>
            <ul class="d-flex align-items-center m-0 p-0">
               <li class="m-0">
                  <h4 href="" class="header26-contact-btn topbar_text_color m-0">Need Help? Call us at <?= $generalConfig['phone_number'] ?> or email us <?= $generalConfig['email'] ?>.</h4>
               </li>
            </ul>
         </div>
      </div>
   ...
   <header>
      ...
      <nav class="navbar navbar-expand-lg nav-color">
         <div class="container container-fluid px-1">
