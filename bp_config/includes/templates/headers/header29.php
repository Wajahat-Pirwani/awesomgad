<section class="header_section header_section29">

   <header>
      <nav class="navbar navbar-expand-lg nav-color">
         <div class="w-100">

            <div class="brand-name-box brand-name px-2">
            ...
            <div class="collapse navbar-collapse nav-menu desktop-menu justify-content-center" id="navbarSupportedContent">
               <ul class="navbar-nav m-0">
                  <li class="nav-item">
                     <a class="nav-link active nav-active-color me-5 px-2" aria-current="page" href="index.php">Home</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link nav-text-color me-5 px-2" href="shop.php">Shop</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link nav-text-color me-5 px-2" href="checkout.php">Checkout</a>
                  </li>
               </ul>
            </div>
            ...
            <div class="brand-name-box cart d-flex justify-content-center">
               <div class="header-icon pe-4 h-100">
                  <!-- <i class="fas fa-map-marker-alt nav-icon-color header29-marker"></i> -->
                  <i class="fas fa-phone-alt nav-color nav-icon-color header29-marker"></i>
               ...
               <ul class="navbar-cart">
                  <li class="cart_link primary_color primary_text_color">
                     <a href="javascript:void(0);" class="">
                        <span class="cart_text"><i class="fas fa-shopping-cart primary_text_color"></i></span>
                        <span class="cart_amt">

                           <!-- <p id="cart_amt" class="subtotalAmount" style="display: inline;"></p> -->
                           <p class="primary_text_color" style="display: inline;">Shopping Cart</p>
                        </span>
                     </a>
