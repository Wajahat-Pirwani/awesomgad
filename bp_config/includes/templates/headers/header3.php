        ...
        <div class="d-flex align-items-center">
          ...
          <?php if ($pageConfig['showNavigationCart'] == 'yes') { ?>
            <ul class="navbar-nav cart-nav ms-auto">
              <li class="cart_link"> <a href="javascript:void(0);"><span class="cart_text nav-text-color"><i class="bi bi-basket fs-2 nav-icon-color"></i> </span> <span class="cart_amt nav-text-color"> <span class="currency_symbol">€</span>
