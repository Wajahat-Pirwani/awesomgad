            ...
            <div>
              <?php if ($pageConfig['showNavigationCart'] == 'yes') { ?>
                <ul class="navbar-nav cart-nav ml-auto">
                  <li class="cart_link"> <a href="javascript:void(0);"><i class="fas fa-shopping-cart   me-2 nav-icon-color"></i> <span class="cart_text nav-text-color"></span> <span class="cart_amt nav-text-color"> <span class="currency_symbol">€</span>
