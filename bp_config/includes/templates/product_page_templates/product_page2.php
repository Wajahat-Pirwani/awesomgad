         ...
         <div class="pdt-data col-lg-9 col-12">
            ...
            <div style="font-size: 15px;">
               <p style="margin-bottom: 5px;">
                  Subtotal: <span class="currency_symbol">€</span><span id="subtotal_price"><?= $subtotalPrice ?? 0; ?></span>
               </p>
            ...
            <div class="price-col">
               <p>
                  Total: <span class="pdt-price-wrapper"><span class="currency_symbol">€</span><span id="single_pdt_price"><?= (isset($subtotalPrice) && isset($shippingPrice)) ? sprintf("%0.2f", $subtotalPrice + $shippingPrice) : 0; ?></span></span>
               </p>
