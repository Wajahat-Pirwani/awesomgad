            ...
            if ($product['straightSaleMultiPrice'] == 'yes') {
               ...
               foreach ($price_quant_combined_arr as $key => $value) {
                  if ($pageConfig['displayShippingPrice'] == "yes")
                     $string .= 'By placing an order you will be billed <span class="currency_symbol">€</span>' . sprintf("%.2f", ($value + $product['ssShipping'])) . ' (<span class="currency_symbol">€</span>' . sprintf("%.2f", $value) . ' + <span class="currency_symbol">€</span>' . sprintf("%.2f", $product['ssShipping']) . ' for shipping) for ' . $product['name'] . ' (' . $key . '). This is a one-time purchase. Shipment via ' . $generalConfig["shipping_carrier"] . ' typically takes ' . $generalConfig["shipping_period"] . ' business days. Your credit card will be billed as “' . $generalConfig['descriptor'] . '” on your statement.<br><br>';
                  else
                     $string .= 'By placing an order you will be billed <span class="currency_symbol">€</span>' . sprintf("%.2f", ($value + $product['ssShipping'])) . ' for shipping) for ' . $product['name'] . ' (' . $key . '). This is a one-time purchase. Shipment via ' . $generalConfig["shipping_carrier"] . ' typically takes ' . $generalConfig["shipping_period"] . ' business days. Your credit card will be billed as “' . $generalConfig['descriptor'] . '” on your statement.<br><br>';
               }
         ?>
               <div class="terms_cond" style="display:none;">
                  ...
                  <?php
                                                         if ($pageConfig['displayShippingPrice'] == "yes")
                                                            echo $typeA = 'By placing an order you will be billed <span class="currency_symbol">€</span>' . sprintf("%.2f", ($product['ssPrice'] + $product['ssShipping'])) . ' (<span class="currency_symbol">€</span>' . sprintf("%.2f", $product['ssPrice']) . ' + <span class="currency_symbol">€</span>' . sprintf("%.2f", $product['ssShipping']) . ' for shipping). This is a one-time purchase. Shipment via ' . $generalConfig["shipping_carrier"] . ' typically takes ' . $generalConfig["shipping_period"] . ' business days. Your credit card will be billed as “' . $generalConfig['descriptor'] . '” on your statement.<br><br></div>';
                                                         else
                                                            echo $typeA = 'By placing an order you will be billed <span class="currency_symbol">€</span>' . sprintf("%.2f", ($product['ssPrice'] + $product['ssShipping'])) . ' for shipping). This is a one-time purchase. Shipment via ' . $generalConfig["shipping_carrier"] . ' typically takes ' . $generalConfig["shipping_period"] . ' business days. Your credit card will be billed as “' . $generalConfig['descriptor'] . '” on your statement.<br><br></div>';
                                                      }
                                                   }
                        ...
                        cartPdtArrNew.forEach(function(f) {
                           ...
                           if (f.Saletype == 1) {
                              <?php if ($pageConfig['displayShippingPrice'] == "yes") { ?>
                                 pdtTerms += '<div class="terms_col" id="terms-' + f.Id + '" data-bill="1"><input type="checkbox" id="prod_agree-' + f.Id + '" name="prod_agree" class="ss_agree-' + f.Id + '" value="agree">&nbsp;By placing an order you will be billed <span class="currency_symbol">€</span><span class="total_price">' + f.Total + '</span> (<span class="currency_symbol">€</span><span class="total_price">' + f.Total + '</span> + <span class="currency_symbol">€</span><span id="ship_price">' + f.Ship + '</span> for shipping) for <span id="prod_name">' + f.Name + '</span>. This is a one-time purchase. Shipment via <?php echo $generalConfig["shipping_carrier"]; ?> typically takes <?php echo $generalConfig["shipping_period"]; ?> business days. Your credit card will be billed as “<?php echo $generalConfig["descriptor"]; ?>” on your statement.</div><br/>';
                              <?php } else { ?>
                                 pdtTerms += '<div class="terms_col" id="terms-' + f.Id + '" data-bill="1"><input type="checkbox" id="prod_agree-' + f.Id + '" name="prod_agree" class="ss_agree-' + f.Id + '" value="agree">&nbsp;By placing an order you will be billed <span class="currency_symbol">€</span><span class="total_price">' + f.Total + ' for <span id="prod_name">' + f.Name + '</span>. This is a one-time purchase. Shipment via <?php echo $generalConfig["shipping_carrier"]; ?> typically takes <?php echo $generalConfig["shipping_period"]; ?> business days. Your credit card will be billed as “<?php echo $generalConfig["descriptor"]; ?>” on your statement.</div><br/>';
                              <?php } ?>
