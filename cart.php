         ...
         cartPdtArrNew.forEach(function(d) {
            if (d.billModel == '2' || d.billModel == '8') {
               <?php if ($showTrialContinuityVerbiage) { ?>
                  ...
                  table += '<td><p>' + d.Name + '</p><p class="cart_amount"><span class="cartNumber" id="cartNumber">' + (showCartNumber ? d.Qty : '') + '</span> X <span class="cartPrice" id="cartPrice"><span class="currency_symbol">€</span>' + d.trlPrice + '</span></p><p class="cart_amount" style="display:none;"> = <span class="cartTotal" id="cartTotal" data-total="' + (d.Qty * d.trlPrice) + '"><span class="currency_symbol">€</span>' + (d.Qty * d.trlPrice) + '</span></p></td>';
                  table += '<td><span class="material-icons close_button close-button" id="close-' + d.Id + '">close</span></td></tr>';
               <?php } ?>
            } else {
               table += '<tr id="row-' + d.Id + '" data-product-id="' + d.Id + '" data-product-name="' + d.Name + '">'
               table += '<td><img src="' + d.Image + '" class="img-fluid  mini-pdt-image" id="mini-image-' + d.Id + '"></td>';
               table += '<td><p>' + d.Name + '</p><p class="cart_amount"><span class="cartNumber" id="cartNumber">' + (showCartNumber ? d.Qty : '') + '</span> X <span class="cartPrice" id="cartPrice"><span class="currency_symbol">€</span>' + d.Price + '</span></p><p class="cart_amount" style="display:none;"> = <span class="cartTotal" id="cartTotal" data-total="' + d.Total + '"><span class="currency_symbol">€</span>' + d.Total + '</span></p></td>';
               table += '<td><span class="material-icons close_button close-button" id="close-' + d.Id + '">close</span></td></tr>';
            }
         })
         ...
         cartPdtArrNew.forEach(function(d) {
            if (d.billModel == '2' || d.billModel == '8') {
               <?php if ($showTrialContinuityVerbiage) { ?>
                  ...
                  table += '<td id="price-' + d.Id + '" class="priceCol" data-ship="' + d.Trlship + '" data-price="' + d.trlPrice + '"><span class="currency_symbol">€</span>' + d.trlPrice + '</td>';
                  <?php if ($pageConfig['displayShippingPrice'] == "yes") { ?>
                     table += '<td id="shipping-' + d.Id + '" data-ship="' + d.Trlship + '"><span class="currency_symbol">€</span>' + d.Trlship + '</td>';
                  <?php } ?>
                  table += '<td id="total-' + d.Id + '" class="totalCol" data-ship="' + d.Trlship + '" data-total="' + (d.trlPrice * d.Qty + d.Trlship * 1) + '"><span class="currency_symbol">€</span>' + (d.trlPrice * d.Qty + d.Trlship * 1).toFixed(2) + '</td>';
               ...
               table += '<td><img src="' + d.Image + '" class="img-fluid cart-pdt-image" id="image-' + d.Id + '"></td>';
               table += '<td colspan="3" id="singlepdt">' + d.Name + '</td>';
               table += '<td id="price-' + d.Id + '" class="priceCol" data-ship="' + d.Ship + '" data-price="' + d.Price + '"><span class="currency_symbol">€</span>' + d.Price + '</td>';
               <?php if ($pageConfig['displayShippingPrice'] == "yes") { ?>
                  table += '<td id="shipping-' + d.Id + '" data-ship="' + d.Ship + '"><span class="currency_symbol">€</span>' + d.Ship + '</td>';
               <?php } ?>
               table += '<td id="total-' + d.Id + '" class="totalCol" data-ship="' + d.Ship + '" data-total="' + (d.Price * d.Qty + d.Ship * 1) + '"><span class="currency_symbol">€</span>' + (d.Price * d.Qty + d.Ship * 1).toFixed(2) + '</td>';
               table += showQtyColumn ? ('<td id="qty-' + d.Id + '" class="qtyCol" data-qty="' + d.Qty + '">' + d.Qty + '</td>') : '';
               table += '</tr>';
            }
         })
