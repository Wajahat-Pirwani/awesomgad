...
<body>
    ...
    <div id="contact-page">
        <?php
        if (file_exists('bp_config/includes/templates/contact_page_templates/contact_page' . $pageConfig['contact_page'] . '.php')) {
            require 'bp_config/includes/templates/contact_page_templates/contact_page' . $pageConfig['contact_page'] . '.php';
        }
        ?>
    </div>
